        ...
        <div v-if="status == 3 || status == 4" class="container">
            ...
            <div class="info">
                ...
                <ul>
                    ...
                    <li><span>理赔金额:</span>{{detailsObject.orderMoney}}</li>
            ...
            <div class="info1">
                <ul>
                    <li class="infoImg">
                        ...
                        <a class="a" :href="detailsObject.downPicUrl" target="_blank">下载</a>
                    </li>
                </ul>
            </div>
            <div class="clear"></div>
            ...
            <div class="info1">
                <ul>
                    ...
                    <li class="infoUp">
                        ...
                        <dl v-if="detailsObject.accountType == 1 && detailsObject.isDrawer == 1">
                        ...
                        <dl v-if="$imgUrl + detailsObject.accountType == 2">
                            <dt><a :href="detailsObject.tbidcardReverseFile" target="_blank"><img :src="$imgUrl + detailsObject.tbidcardReverseFile"/></a></dt>
                            <dd>
        ...
        <div v-if="status == 8" class="container">
            ...
            <div class="info1">
                <ul>
                    ...
                    <li class="infoUp">
                        <span>营业执照：</span>
                        <dl v-if="$imgUrl + detailsObject.accountType == 1">
                        ...
                        <dl v-if="$imgUrl + detailsObject.accountType == 1 && detailsObject.isDrawer == 1">
                        ...
                        <dl v-if="$imgUrl + detailsObject.accountType == 2">
                            <dt><a :href="detailsObject.tbidcardFrontFile" target="_blank"><img :src="$imgUrl + detailsObject.tbidcardFrontFile"/></a></dt>
                            <dd>
                                <a @click="insuDownload(detailsObject.tbidcardFrontFile)">下载</a>
                                <strong>(身份证正面)</strong>
                            </dd>
...
<script>
    ...
    export default {
        ...
        methods: {
            //初始化详情
            loadDetails() {
                this.$fetch(`${this.$api}insuOrder/getInsuOrderById/${this.$route.params.id}`).then(
                    (res) => {
                        if (res.success && res.code == 0) {
                            this.detailsObject = res.data;
                            this.blindTime = moment(this.detailsObject.blindStartTime).format('YYYY-MM-DD') + '-' + moment(this.detailsObject.blindEndTime).format('YYYY-MM-DD');
                            if(this.detailsObject.picUrl){this.detailsObject.picUrl = this.detailsObject.picUrl.split(',')[0]}
                            if(this.detailsObject.businessLicenseFile){(this.detailsObject.businessLicenseFile.indexOf(this.$imgUrl) == -1 ? this.detailsObject.businessLicenseFile = this.$pcImg + this.detailsObject.businessLicenseFile : this.detailsObject.businessLicenseFile)}
            ...
            nolipeiButton(formName){
                ...
                this.$refs[formName].validate( (result) => {
                    if(result){
                        this.$put(`${this.$api}insuOrder/updateInsuUnPassStatus`,this.lipeiForm).then(
                            (res) => {
                                if(res.success && res.code == 0){
                                    this.$message({
                                        type:'success',
            ...
            lipeiButton(){
                ...
                this.$confirm('提交成功后，该客户在同一次提交的申请订单都将审核通过。', '提示', {
                    ...
                    this.$put(`${this.$api}insuOrder/updateInsuPassStatus`,this.lipeiSuccess).then(
                        (res) => {
                            if(res.success && res.code == 0){
                                this.$message({
                                    type:'success',
            ...
            nozhifuButton(formName){
                ...
                this.$refs[formName].validate( (result) => {
                    if(result){
                        this.$put(`${this.$api}insuOrder/updateInsuPayFailStatus`,this.zhifuForm).then(
                            (res) => {
                                if(res.success && res.code == 0){
                                    this.$message({
                                        type:'success',
            ...
            zhifuButton(){
                ...
                this.$confirm('提交成功后，该客户在同一次提交的申请订单都将审核通过。', '提示', {
                    ...
                    this.$put(`${this.$api}insuOrder/updateInsuPaystatus`,this.zhifuSuccess).then(
                        (res) => {
                            if(res.success && res.code == 0){
                                this.$message({
                                    type:'success',
