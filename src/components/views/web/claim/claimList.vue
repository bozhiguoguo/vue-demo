    ...
    <div>
        ...
        <div class="tableBox">
            <el-table
              ...
              <el-table-column prop="defaultAmendsMoney" label="保险限额" header-align="center" width="220">
                <template slot-scope="scope">
            ...
            throughClaims() {
                ...
                this.$msgbox({
                    ...
                    beforeClose: (action, instance, done) => {
                        if (action === 'confirm') {
                          this.$put(this.$api + '/insuOrder/updateInsuPassStatus', {amendidList: this.checkedCities}).then((res) => {
                                if (res.success && res.code == 0) {
                                    this.loadlist();
                                    this.checkAll=false;
