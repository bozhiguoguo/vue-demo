<template>
    ...
    <div>
        <div class="bthBox">
            ...
            <el-button type="danger" round @click="is_icon = 5;tiggerGroductType()" size="small">商标综合保险 <i v-if="is_icon == 5" class="el-icon-check"></i></el-button>
        ...
        data () {
            return {
                ...
                searchForm:{
                    ...
                    productType:'',	//否	int	保险类型：1.盲查保 2.果保商标 3.全程保 4.果保专利
