                ...
                <el-col v-show="productType == 1 || productType == 4" :span="4">
                    <el-form-item label="产品名称：">
                        <el-select v-model="searchForm.productName" placeholder="请选择产品名称" class="w130" size="small">
                            ...
                            <el-option label="果益商标注册" value="果益商标注册"></el-option>
                            <el-option label="加急商标注册" value="加急商标注册"></el-option>
                            <el-option label="尊享商标注册" value="尊享商标注册"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col v-show="productType == 1 || productType == 4 || productType == 3" :span="4">
                    <el-form-item label="保险产品：">
                        <el-select v-model="searchForm.insuName" placeholder="请选择保险产品" class="w130" size="small">
                            ...
                            <el-option v-show="productType == 4" label="全程保商标注册" value="全程保商标注册"></el-option>
    ...
    export default {
        ...
        data() {
            return {
                ...
                searchForm: {
                    ...
                    productType: 1,	//否	int	保险类型：1.盲查保 2.果保商标 3.全程保 4.果保专利
                ...
                indexCon: '',
                cols: [
                    {id: 1, prop: 'productName', label: '产品名称', isShow: true,width: 150,fixed:true},
                    {id: 2, prop: 'insuName', label: '保险产品', isShow: true,width: 150},
                    ...
                    {id: 10, prop: 'applyName', label: '申请名称', isShow: true,width: 150},
                    {id: 11, prop: 'category', label: '申请类别', isShow: true,width: 150},
                    {id: 12, prop: 'isReport', label: '是否报件', isShow: false, formatter: this.isReport,width: 150},
                    {id: 13, prop: 'applyTime', label: '申请日期', isShow: true,width: 150},
                    {id: 14, prop: 'blindStartTime', label: '盲查期间', isShow: true,width: 200, formatter: this.ConnectBlinTime},
                    {id: 15, prop: 'itermNum', label: '商标超项数', isShow: true,width: 150, formatter: this.ItermNum},
                    ...
                    {id: 20, prop: 'ordercode', label: '订单号', isShow: false,width: 150},
                    {id: 21, prop: 'applyCode', label: '申请号 ', isShow: true,width: 150},
                    ...
                    {id: 25, prop: 'devoteInsuTime', label: '投保时间', isShow: false,width: 150},
                    {id: 26, prop: 'status', label: '最新状态', isShow: false, formatter: this.status,width: 150},
                    {id: 27, prop: 'gwName', label: '当前顾问名称', isShow: true,width: 150},
                    ...
                    {id: 30, prop: 'isAmends', label: '人工复核结果', isShow: false,width: 150, formatter: this.isAmends},
                    {id: 31, prop: 'isHadAmends', label: '是否已经理赔', isShow: false,width: 150, formatter: this.isHadAmends},
                    {id: 32, prop: 'bodyName', label: '被保险人名称', isShow: true,width: 150},
                    ...
                    {id: 37, prop: 'amendsMoney', label: '理赔金额', isShow: true,width: 150},
                    {id: 38, prop: 'resultFlag', label: '系统判断结果', isShow: true,width: 150, formatter: this.resultFlag},
                ],
                cols1: [
                    {id: 1, prop: 'productName', label: '产品名称', isShow: true,width: 150,fixed:true},
                    {id: 2, prop: 'insuName', label: '保险产品', isShow: true,width: 150},
                    ...
                    {id: 12, prop: 'isReport', label: '是否报件', isShow: false, formatter: this.isReport,width: 150},
                    {id: 13, prop: 'applyTime', label: '申请日期', isShow: true,width: 150},
                    {id: 14, prop: 'blindStartTime', label: '盲查期间', isShow: true,width: 150, formatter: this.ConnectBlinTime},
                    {id: 15, prop: 'itermNum', label: '商标超项数', isShow: true,width: 150, formatter: this.ItermNum},
                    {id: 16, prop: 'agency', label: '代理机构', isShow: false,width: 150},
                    {id: 18, prop: 'identCode', label: '身份证号', isShow: false,width: 150},
                    {id: 19, prop: 'regAddress', label: '注册地址', isShow: false,width: 150},
        ...
        methods: {
            ...
            loadlist() {
                ...
                this.$post(`${this.$api}insuOrder/getInsuOrderListByPage`, self.searchForm).then((res) => {
            ...
            handleClick: function (scope) {
                ...
                self.$fetch(self.$api + 'insuOcrresult/getInsuOcrresultByOrderCode/' + scope.ordercode).then((res) => {
                  if(!!res.data && res.success){
                    ...
                    self.insuranceData.picArray = res.data.rejectPicUrl.split(",");
            ...
            claimInformation: function () {
                ...
                this.$msgbox({
                    ...
                    beforeClose: (action, instance, done) => {
                        if (action === 'confirm') {
                            this.$put(`${this.$api}insuOrder/confirmSendAmends`, {idList: self.checkSelection}).then((res) => {
                                if (res.success && res.code == 0) {
                                    self.tableData = res.data.list;
            ...
            exportExcel(){
                ...
                this.$exportExcel(`${this.$api}insuOrder/importInsuOrderExcel`,this.exporeExcelObject).then(
                    (res) => {
                        this.$message({
                            type:'success',
                            message:'导出成功'
