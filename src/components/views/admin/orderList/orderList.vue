        ...
        data (){
            return {
                ...
                cols:[
                    ...
                    {id:3,prop:'inseCode',label:'保险编号',isShow:true,width:'200px'},
                    {id:4,prop:'orderMoney',label:'订单金额',isShow:true,width:'150px'},
                    {id:5,prop:'orderPublicexp',label:'申请官费',isShow:true,width:'150px'},
                    {id:6,prop:'orderServeexp',label:'订单服务费',isShow:true,width:'150px'},
                    {id:7,prop:'insuServeexp',label:'保险服务费',isShow:true,width:'150px'},
                    ...
                    {id:26,prop:'status',label:'最新状态',isShow:true,formatter:this.status,width:'150px'},
                    {id:27,prop:'gwName',label:'当前顾问名称',isShow:true,width:'150px'},
                ...
                cols1:[
                    ...
                    {id:3,prop:'inseCode',label:'保险编号',isShow:true},
                    {id:4,prop:'orderMoney',label:'订单金额',isShow:true},
                    {id:5,prop:'orderPublicexp',label:'申请官费',isShow:true},
                    {id:6,prop:'orderServeexp',label:'订单服务费',isShow:true},
                    {id:7,prop:'insuServeexp',label:'保险服务费',isShow:true},
                    ...
                    {id:26,prop:'status',label:'最新状态',isShow:true,},
                    {id:27,prop:'gwName',label:'当前顾问名称',isShow:true,},
